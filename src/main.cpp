...
int main()
{
    ...
    int N = 3; // number of samples in the nominal data set (data guaranteed to have no anomalies)
    ...
    // // GEM Online phase
    // X = random_dataset(p, N, false/*normal*/, 5.0, 1.1); // anomalous dataset
